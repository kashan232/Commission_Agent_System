...
<body>
                                ...
                                <ul class="profile-dropdown onhover-show-div">
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();"><i data-feather="log-in"> </i><span>Log out</span></a>
                                        </form>
    ...
    <script src="assets/js/calendar/custom-calendar.js">
    </script>
